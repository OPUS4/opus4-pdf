...
class DefaultMatcherTest extends TestCase
{
    ...
    {
        // TODO config should be automatically reset/reloaded
        $this->adjustConfiguration([
            'pdf' => ['covers' => ['default' => null]],
        ]);
    ...
    {
        $this->adjustConfiguration([
            'pdf' => ['covers' => ['default' => 'template1']],
        ]);

        $doc = Document::new();

        $this->assertEquals('template1', $this->matcher->getTemplate($doc));
    }

    public function testGetTemplateNoDefaultConfigured()
    {
        $doc = Document::new();
