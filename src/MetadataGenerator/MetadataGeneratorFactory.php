...
{
    /**
     * @param string $metadataFormat The metadata format to be used by the returned metadata generator.
     * @return MetadataGeneratorInterface|null
     */
    public static function create($metadataFormat)
    {
        $generatorClass = null;

        if ($metadataFormat === MetadataGeneratorInterface::METADATA_FORMAT_CSL_JSON) {
            $generatorClass = CslMetadataGenerator::class;
        }
